...
public class ITestListenerLogic implements ITestListener {
	...
	public void onTestSuccess(ITestResult result) {
		...
		File destination=new File("C:\\Users\\User\\eclipse-workspace\\AmazonMavenProject\\PassScreenshot\\screenshot" +result.getTestClass()+format2+".png");//by creating object and using getclass() method
		try {
